 ...
 */
final class Version20200924095013 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE trace (id VARCHAR(255) NOT NULL, person_email VARCHAR(255) NOT NULL, saw_email VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
